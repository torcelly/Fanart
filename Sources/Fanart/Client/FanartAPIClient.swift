...
final actor FanartAPIClient: APIClient {
    ...
    func get<Response: Decodable>(path: URL) async throws -> Response {
        ...
        do {
            ...
            throw FanartError.network(error)
        }
...
extension FanartAPIClient {
    ...
    private func validate(response: URLResponse) throws {
        if let fanartError = FanartError(response: response) {
            throw fanartError
        }
    }
