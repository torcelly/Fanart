...
final class TMDbAPIClientTests: XCTestCase {
    ...
    override func setUp() {
        ...
        apiClient = FanartAPIClient(apiKey: apiKey, baseURL: baseURL, urlSession: urlSession, serialiser: serialiser)
    }
    ...
    func testGetURLRequestHasCorrectURL() async throws {
        let path = "/object"
        let urlString = "\(baseURL.absoluteURL)\(path)?api_key=\(apiKey!)"
